...
INSERT INTO codes (code, name, description, category, sort_order, is_active, created_at, updated_at) VALUES
('ACTIVE', 'Active', 'Member is active in the group', 'GROUP_MEMBER_STATUS', 10, true, NOW(), NOW()),
('PENDING', 'Pending', 'Member invitation is pending acceptance', 'GROUP_MEMBER_STATUS', 20, true, NOW(), NOW());

-- Group Type Constants
INSERT INTO codes (code, name, description, category, sort_order, is_active, created_at, updated_at) VALUES
('FAMILY', 'Family', 'Family group type for parent-child relationships', 'GROUP_TYPE', 10, true, NOW(), NOW());

-- User Role Constants
INSERT INTO codes (code, name, description, category, sort_order, is_active, created_at, updated_at) VALUES
('ADMIN', 'Administrator', 'System administrator with full access', 'USER_ROLE', 10, true, NOW(), NOW()),
('PARENT', 'Parent', 'Parent user who can manage children', 'USER_ROLE', 20, true, NOW(), NOW()),
('STUDENT', 'Student', 'Student user (child account)', 'USER_ROLE', 30, true, NOW(), NOW()),
('TEACHER', 'Teacher', 'Teacher user for educational content', 'USER_ROLE', 40, true, NOW(), NOW());

-- Message Status Constants
INSERT INTO codes (code, name, description, category, sort_order, is_active, created_at, updated_at) VALUES
('QUEUED', 'Queued', 'Message waiting to be sent', 'MESSAGE_STATUS', 10, true, NOW(), NOW()),
('SENDING', 'Sending', 'Message currently being sent', 'MESSAGE_STATUS', 20, true, NOW(), NOW()),
('SENT', 'Sent', 'Message successfully delivered', 'MESSAGE_STATUS', 30, true, NOW(), NOW()),
('FAILED', 'Failed', 'Message failed to send', 'MESSAGE_STATUS', 40, true, NOW(), NOW()),
('STREAMING', 'Streaming', 'AI response currently streaming', 'MESSAGE_STATUS', 50, true, NOW(), NOW()),
('USER_MESSAGE', 'User Message', 'User message completed', 'MESSAGE_STATUS', 60, true, NOW(), NOW()),
('ERROR', 'Error', 'Error occurred during processing', 'MESSAGE_STATUS', 70, true, NOW(), NOW()),
('COMPLETED', 'Completed', 'Message processing completed', 'MESSAGE_STATUS', 80, true, NOW(), NOW()),
('TIMEOUT', 'Timeout', 'Message timed out', 'MESSAGE_STATUS', 90, true, NOW(), NOW()),
('CANCELLED', 'Cancelled', 'Message was cancelled', 'MESSAGE_STATUS', 100, true, NOW(), NOW()),
('VALIDATION_ERROR', 'Validation Error', 'Message validation failed', 'MESSAGE_STATUS', 110, true, NOW(), NOW());

-- Entity Status Constants (for products, characters, subjects)
INSERT INTO codes (code, name, description, category, sort_order, is_active, created_at, updated_at) VALUES
('ACTIVE', 'Active', 'Entity is active and visible', 'ENTITY_STATUS', 10, true, NOW(), NOW()),
('INACTIVE', 'Inactive', 'Entity is inactive and hidden', 'ENTITY_STATUS', 20, true, NOW(), NOW());

-- Transfer Type Constants
INSERT INTO codes (code, name, description, category, sort_order, is_active, created_at, updated_at) VALUES
('QUIZ_REWARD', 'Quiz Reward', 'Credits earned from completing quizzes', 'TRANSFER_TYPE', 10, true, NOW(), NOW()),
('PARENT_TO_CHILD', 'Parent to Child', 'Credits transferred from parent to child', 'TRANSFER_TYPE', 20, true, NOW(), NOW()),
('INTERNAL_PLEDGE', 'Internal Pledge', 'Internal credit pledge or topup', 'TRANSFER_TYPE', 30, true, NOW(), NOW());

-- Feedback Type Constants
INSERT INTO codes (code, name, description, category, sort_order, is_active, created_at, updated_at) VALUES
('LIKE', 'Like', 'Positive feedback on message', 'FEEDBACK_TYPE', 10, true, NOW(), NOW()),
('DISLIKE', 'Dislike', 'Negative feedback on message', 'FEEDBACK_TYPE', 20, true, NOW(), NOW());

-- Stripe Mode Constants
INSERT INTO codes (code, name, description, category, sort_order, is_active, created_at, updated_at) VALUES
('PAYMENT', 'Payment', 'One-time payment checkout', 'STRIPE_MODE', 10, true, NOW(), NOW()),
('SUBSCRIPTION', 'Subscription', 'Recurring subscription checkout', 'STRIPE_MODE', 20, true, NOW(), NOW());

-- Study Type Constants
INSERT INTO codes (code, name, description, category, sort_order, is_active, created_at, updated_at) VALUES
('LESSON', 'Lesson', 'Learn new material', 'STUDY_TYPE', 10, true, NOW(), NOW()),
('PRACTICE', 'Practice', 'Practice with questions', 'STUDY_TYPE', 20, true, NOW(), NOW()),
('QUIZ', 'Quiz', 'Take a quiz assessment', 'STUDY_TYPE', 30, true, NOW(), NOW());

-- Generation Intent Type Constants
INSERT INTO codes (code, name, description, category, sort_order, is_active, created_at, updated_at) VALUES
('STANDARD_RESPONSE', 'Standard Response', 'Regular chat response', 'GENERATION_INTENT_TYPE', 10, true, NOW(), NOW()),
('LESSON', 'Lesson', 'AI-generated lesson content', 'GENERATION_INTENT_TYPE', 20, true, NOW(), NOW()),
('QUIZ', 'Quiz', 'AI-generated quiz questions', 'GENERATION_INTENT_TYPE', 30, true, NOW(), NOW());
