...
(
  ...
  'Winnie is a warm, friendly bear who loves exploring nature and biology. He makes complex biological concepts easy to understand through simple analogies and his gentle, nurturing approach.',
  true,
  2,
  NOW(),
  NOW()
...
(
  ...
  '${SUPABASE_STORAGE_URL}/characters/future.png',
  'Future is an innovative character who loves chemistry and technology. He brings excitement to learning about chemical reactions and helps students understand complex scientific concepts through modern approaches.',
  true,
  3,
  NOW(),
  NOW()
...
(
  ...
  '${SUPABASE_STORAGE_URL}/characters/maya.png',
...
(
  ...
  '${SUPABASE_STORAGE_URL}/characters/sherlock.png',
...
(
  ...
  '${SUPABASE_STORAGE_URL}/characters/mickey.png',
