  ...
  <div class="mx-auto sm:w-11/12 sm:max-w-6xl sm:px-6">
    ...
    <div v-else ref="content">
      ...
      <div class="mt-6 flex flex-col items-center gap-4 md:flex-row md:justify-center md:flex-wrap">
        ...
        <UButton
          class="px-6 py-3 bg-zinc-500 hover:bg-zinc-600 text-white dark:bg-zinc-400 dark:hover:bg-zinc-300 dark:text-black"
          @click="retryQuiz"
        >
          Retry Quiz
        </UButton>
        ...
        <UButton
          class="px-6 py-3 bg-yellow-500 hover:bg-yellow-600 text-white dark:bg-yellow-400 dark:hover:bg-yellow-300 dark:text-black"
        ...
        <UButton
          class="px-6 py-3 bg-indigo-500 hover:bg-indigo-600 text-white dark:bg-indigo-400 dark:hover:bg-indigo-300 dark:text-black"
