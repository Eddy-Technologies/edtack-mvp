<template>
  <div class="mx-auto sm:w-11/12 sm:max-w-6xl sm:px-6">
    ...
    <div v-else ref="content">
      ...
      <div class="mt-8 p-6 bg-blue-50 border border-blue-200 text-center rounded-lg shadow">
      ...
      <div class="mt-6 flex flex-col items-center gap-4 md:flex-row md:justify-center md:flex-wrap">
        ...
        <UButton class="px-6 py-3 bg-zinc-500 hover:bg-zinc-600 text-white" @click="retryQuiz">
          Retry Quiz
        </UButton>
