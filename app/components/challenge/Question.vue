  ...
  <div ref="content" class="question">
    ...
    <div v-for="(option, index) in question.options" :key="index">
      <label
        ...
        :class="{
          'bg-blue-50 border-emerald-500 ': selectedAnswer === option,
          'hover:bg-blue-50 hover:border-emerald-500 ': selectedAnswer !== option,
        }"
      >
        <input
          type="radio"
    ...
    <UButton
      class="mt-4 px-3 py-1 text-sm bg-red-400 rounded hover:bg-red-300 transition"
