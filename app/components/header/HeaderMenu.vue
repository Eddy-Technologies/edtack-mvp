<template>
  <div class="relative">
    ...
    <div class="hidden md:flex items-center gap-x-4">
      <UIcon name="i-heroicons-currency-dollar-16-solid" class="h-5 w-5 text-white-400" />
      <span class="text-l font-bold text-gray-700">{{ credits }}</span>
    ...
    >
      <div
        v-if="showMobileMenu"
        class="absolute right-0 mt-2 w-32 bg-white shadow-lg rounded-md p-4 z-50 md:hidden"
      >
