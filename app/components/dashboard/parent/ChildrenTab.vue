  ...
  <div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border p-4">
      <div class="flex items-center justify-between">
        <h2 class="text-xl font-bold text-gray-900">Children Management</h2>
          ...
          <div class="p-6">
            <div class="grid grid-cols-2 gap-3">
              <button
                ...
                @click="viewChildAnalytics(child.id)"
              >
                View Analytics
              </button>
            ...
            <div class="mt-4 pt-4 border-t">
              ...
              <div class="w-full bg-gray-200 rounded-full h-2">
                <div class="bg-blue-500 h-2 rounded-full" :style="{ width: (child.screenTime.used / child.screenTime.limit) * 100 + '%' }" />
              </div>
    ...
    <!-- Analytics View -->
    <ChildrenAnalyticsPage v-if="currentView === 'analytics'" />
  </div>
</template>

<script setup lang="ts">
import { ref } from 'vue';
import ChildrenAnalyticsPage from '../child-analytics/ChildrenAnalyticsPage.vue';

const currentView = ref<'overview' | 'analytics'>('overview');
...
const viewChildAnalytics = (_childId: number) => {
