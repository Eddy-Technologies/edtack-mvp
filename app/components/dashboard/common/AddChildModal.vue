  ...
  <div v-if="isOpen" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-6" @click="closeModal">
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full" @click.stop>
      <div class="flex items-center justify-between p-6 border-b">
        <h2 class="text-xl font-bold text-gray-900">Add Child</h2>
        ...
        <div>
          <div class="space-y-4">
            ...
            <div>
              ...
              <input v-model="childData.email" type="email" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
          ...
          <div class="flex space-x-4 mt-6">
            ...
            <Button variant="primary" text="Add Child" extra-classes="flex-1" @clicked="addChild" />
          </div>
        </div>
      </div>
    </div>
...
const addChild = () => {
  emit('child-added', childData.value);
  closeModal();
};
</script>
