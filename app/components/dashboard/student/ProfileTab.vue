...
const subjects = ref([
  { name: 'Mathematics', emoji: '🔢', level: 'Advanced', color: '#3B82F6' },
  { name: 'Science', emoji: '🔬', level: 'Grade Level', color: '#10B981' },
  { name: 'English', emoji: '📚', level: 'Advanced', color: '#8B5CF6' },
  { name: 'History', emoji: '🏛️', level: 'Grade Level', color: '#F59E0B' },
