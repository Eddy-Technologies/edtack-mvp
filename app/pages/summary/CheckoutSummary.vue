    ...
    <div class="page-content bg-white">
      ...
      <div class="confirmation-content">
        <div class="cart-and-withdrawal">
              ...
              <div class="item-actions">
                <button class="btn-icon btn-delete" title="Delete item">
                  <UIcon
                    ...
                    class="icon w-6 h-6 text-primary sm:text-primary sm: shrink-0 px-4"
          ...
          <div class="cart-summary bg-gray-100">
        ...
        <div class="cashflow-summary">
          ...
          <div class="cashflow-details bg-gray-100">
            <div class="summary-row">
      ...
      <button class="btn-confirm" :disabled="isInvalidCheckout" @click="confirmOrder">
        Confirm Order
      </button>
    </div>
  </div>
