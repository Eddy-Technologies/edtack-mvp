    ...
    <div class="relative z-10 px-4 sm:px-8 pb-8">
      ...
      <div ref="browseCharacters" class="mb-12">
        ...
        <div class="max-w-4xl mx-auto">
          <!-- 3x3 Grid for first 9 characters, but line-by-line on mobile -->
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-6">
            ...
            >
              <div
                class="relative h-[280px] w-full md:w-[280px] bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg p-3 sm:p-4 text-center hover:from-gray-200 hover:to-gray-300 transition-all duration-300 group-hover:scale-105 shadow-sm hover:shadow-md"
              >
          ...
          <!-- Expandable grid for remaining characters, also line-by-line on mobile -->
          <div
            v-if="showAllCharacters && allAvatars.length > 9"
            class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-6"
          >
            <div
