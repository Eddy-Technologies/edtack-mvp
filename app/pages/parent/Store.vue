<template>
 ...
 :key="setting"
 class="bg-white border border-gray-300 rounded-xl p-4 shadow-md md:max-w-[600px] max-w-[350px]"
 >
 <div class="flex items-center gap-4 flex-wrap">
 <!-- Setting Name -->
 <h2 class="text-lg font-semibold text-gray-800 min-w-[150px]">
 {{ setting }}
 </h2>
 ...
 :class="settingsState[setting][child] ? 'bg-primary text-white' : 'bg-gray-200 text-gray-800 '"
 >
 {{ child }}
 </span>
 </div>
