  ...
  public: {
    Tables: {
      chapter: {
        ...
        Relationships: [
          {
            foreignKeyName: 'chapter_parent_id_fkey';
            columns: ['parent_id'];
            isOneToOne: false;
          ...
          {
            foreignKeyName: 'chapter_subject_id_fkey';
            columns: ['subject_id'];
            isOneToOne: false;
      ...
      curriculum_subjects: {
        ...
        Relationships: [
          {
            foreignKeyName: 'curriculum_subjects_level_type_fkey';
            columns: ['level_type'];
            isOneToOne: false;
          ...
          {
            foreignKeyName: 'curriculum_subjects_subject_fkey';
            columns: ['subject'];
            isOneToOne: false;
            referencedRelation: 'subjects';
            referencedColumns: ['name'];
          ...
          {
            foreignKeyName: 'curriculum_subjects_syllabus_type_fkey';
            columns: ['syllabus_type'];
            isOneToOne: false;
            referencedRelation: 'syllabus_types';
            referencedColumns: ['syllabus_type'];
          },
        ];
      };
      group_members: {
      ...
      user_infos: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'user_infos_syllabus_type_fkey';
            columns: ['syllabus_type'];
            isOneToOne: false;
            referencedRelation: 'syllabus_types';
            referencedColumns: ['syllabus_type'];
